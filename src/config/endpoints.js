...
export const API_ENDPOINTS = [
  ...
  },
  {
    ...
    healthPath: '/v1/odds?league=nba&sourceType=all&limit=10',
    tier: 'starter',
  },
  {
    id: 'odds_dfs',
    ...
    healthPath: '/v1/odds?league=nba&sourceType=dfs&limit=10',
    tier: 'starter',
  },
  {
    id: 'odds_event',
    category: 'Odds',
    label: 'Event Odds + Summary',
    method: 'GET',
    path: '/v1/events/{eventId}/odds',
    healthPath: null,
    healthPathTemplate: '/v1/events/{eventId}/odds',
    tier: 'starter',
  },
  ...
  {
    id: 'player_props_event',
    category: 'Player Props',
    label: 'Event Player Props + Summary',
    method: 'GET',
    path: '/v1/events/{eventId}/player-props',
    healthPath: null,
    healthPathTemplate: '/v1/events/{eventId}/player-props?market=player_points',
    tier: 'starter',
  },
  ...
  // ── Edge ───────────────────────────────────────────────────
  {
    ...
    healthPath: '/v1/edge?league=nba&sourceType=all&limit=10',
    tier: 'pro',
  },
  {
    id: 'edge_value',
    ...
    healthPath: '/v1/edge/value?league=nba&sourceType=all&limit=10',
    tier: 'pro',
  },
  {
    id: 'edge_ev',
    ...
    healthPath: '/v1/edge/ev?league=nba&sourceType=all&limit=10',
    tier: 'pro',
  },
  {
    id: 'edge_arbitrage',
    ...
    healthPath: '/v1/edge/arbitrage?league=nba&sourceType=all&limit=10',
    tier: 'pro',
  },
  {
    id: 'edge_event',
    category: 'Edge',
    label: 'Event Edge Analysis',
    method: 'GET',
    path: '/v1/events/{eventId}/edge',
    healthPath: null,
    healthPathTemplate: '/v1/events/{eventId}/edge',
    tier: 'pro',
  },
  ...
  // ── Player Analysis ────────────────────────────────────────
  {
    ...
    healthPath: '/v1/players/trending?league=nba&market=player_points&sortBy=l5&limit=10',
    tier: 'pro',
  },
  {
    ...
    healthPath: '/v1/players/trending?league=nhl&market=player_shots_on_goal&sortBy=l5&limit=10',
    tier: 'pro',
  },
  {
